...
switch (mes) {
  ...
  case 2:
  case 3:
    console.log("Nos encontramos en el primero trimestre");
    break;
  case 4:
  case 5:
  case 6:
  ...
  case 8:
  case 9:
    console.log("Nos encontramos en el tercera trimestre");
    break;
  case 10:
  case 11:
  case 12:
    console.log("Nos encontramos en el cuarta trimestre");
    break;
  default:
    console.log("No existe este mes");
    break;
}
